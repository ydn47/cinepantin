...
public class Article implements SerialArticle {
	...
	public byte[] serialize(HashMap<?, ?> hashmap) throws IOException {
		...
		try {
			...
			throw new IOException("Erreur de s�rialisation" + ioex);
		}
	...
	/**
	 * Retourne les propri�t�s s�rialis�es de l'article
	 * 
	 * @return les propri�t�s s�rialis�es de l'article
	 */
	...
	/**
	 * M�thode qui renvoie les propri�t�s d�s�rialis�es d'un article
	 * 
