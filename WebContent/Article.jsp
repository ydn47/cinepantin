...
<body style="padding-top: 100px">
	...
	<div class="container">
		...
		<div class="row featurette">
			<p id="succes">Il y a actuellement :${nbvisiteurs} utilisateur(s)
				connecté(s)</p>
			<div class="col-md-5">
			...
			<div class="col-md-7">
				...
				<form class="form-inline" role="form" method="post"
					action="${paniercont}" id="form-product-details">
					<!-- Hidden fields -->
					<div class="hidden">
					...
					<div class="form-group">
						...
						<label for="quantity">Quantité</label> <input type="number"
							required min="1" max="5" value="1" class="form-control"
							id="quantity" name="quantity" size="10" />
					</div>
					<input tabindex="3" class="btn primary large" type="submit"
						name="addCart" value="Ajouter au panier" />
